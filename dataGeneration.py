...
activitiesDict = {
    1: "Learn to play a new musical instrument, Volunteer at a local animal shelter, Learn to knit or crochet, Take a photography class, Learn a new language",
    2: "Start a blog or vlog, Learn to play a new musical instrument, Take a beginner's coding class, Go on a solo camping trip, Take a photography class, Start a book club",
    ...
    4: "Go on a solo camping trip, Start a book club, Try a new cuisine, Take a photography class, Learn to paint or draw,",
    5: "Take a pottery class, Start a home garden Learn a new language, Learn to play a new musical instrument, Learn to play a board game, Take a dance class",
    6: "Learn to play a card game, Learn to bake bread, Learn to play a new musical instrument, Learn to play a board game, Take a dance class",
    7: "Learn to play a board game, Take a dance class, Learn to play a card game, Take a pottery class, Learn to bake bread, Take a photography class",
    8: "Learn to knit or crochet, Go on a solo camping trip, Take a photography class, Start a book club, Start a vegetable garden",
    9: "Learn to knit or crochet, Take a photography class, Learn to paint or draw, Start a book club, Learn to play a board game",
    10: "Learn to play a card game, Start a book club, Go on a solo camping trip, Start a book club, Start a vegetable garden",
    11: "Take a calligraphy class, Take a beginner's coding class, Learn to knit or crochet, Try a new cuisine, Learn to paint or draw,",
    12: "Learn to play a card game, Learn to bake bread, Take a photography class, Learn to play a card game, Try a new cuisine, Learn to paint or draw, Start a book club",
    13: "Take a DIY home improvement class, Try a new cuisine, Take a dance class, Learn to play a card game",
    14: "Volunteer at a local animal shelter, Take a dance class, Start a blog or vlog, Take a DIY home improvement class, Learn to play a new musical instrument",
    15: "Learn to knit or crochet, Learn to paint or draw, Take a pottery class, Start a home garden, Go on a solo camping trip",
    16: "Go on a solo camping trip, Learn to paint or draw, Go on a solo camping trip,Take a photography class",
    ...
    18: "Take a calligraphy classTake a pottery class, Learn to play a board game, Start a home garden",
    ...
    21: "Learn to knit or crochet, Learn to play a board game, Take a calligraphy class, Start a home garden, Learn to play a new musical instrument",
    22: "Learn to play a board game, Take a pottery class, Start a home garden, Go on a solo camping trip",
    23: "Take a pottery class, Start a home garden  Try a new cuisine,Start a vegetable garden, Volunteer at a local animal shelter",
    24: "Start a home garden  Try a new cuisine, Start a book club",
    25: "Take a DIY home improvement class, Learn to play a new musical instrument, Take a beginner's coding class, Go on a solo camping trip, Start a book club",
    26: "Volunteer at a local animal shelter, Try a new cuisine  Take a calligraphy class, Learn to bake bread",
    ...
    28: "Go on a solo camping trip, Take a calligraphy class, Take a calligraphy class, Volunteer at a local animal shelter, Learn to knit or crochet Learn a new language",
    29: "Take a pottery class, Learn to bake bread, Go on a solo camping trip,Start a book club, Learn to knit or crochet",
    30: "Learn to play a card game, Take a beginner's coding class, Start a book club, Take a beginner's coding class, Take a pottery class, Learn to play a board game",
    31: "Take a DIY home improvement class, Learn to bake bread, Learn a new language, Take a DIY home improvement class, Learn to play a new musical instrument",
    ...
    35: "Volunteer at a local animal shelter, Take a photography class, Learn a new language",
    ...
    37: "Take a DIY home improvement class, Learn to play a new musical instrument, Take a beginner's coding class, Go on a solo camping trip, Take a photography class, Learn a new language",
    38: "Volunteer at a local animal shelter, Take a dance class, Learn to bake bread, Start a book club, Take a beginner's coding class",
    39: "Take a photography class, Start a book club, Start a vegetable garden",
    ...
    41: "Go on a solo camping trip, Take a DIY home improvement class, Take a beginner's coding class",
    ...
    45: "Learn to knit or crochet, Start a book club, Try a new cuisine, Start a book club,  Volunteer at a local animal shelter",
    46: "Try a new cuisine, Start a vegetable garden, Learn to paint or draw, Start a book club, Learn to knit or crochet",
    47: "Go on a solo camping trip, Start a home garden, Start a vegetable garden, Try a new cuisine, Take a dance class, Start a blog or vlog, Learn a new language",
    ...
    50: "Try a new cuisine, Take a dance class, Go on a solo camping trip, Learn to play a board game, Start a home garden, Start a vegetable garden",
    51: "Learn to knit or crochet, Take a photography class, Take a beginner's coding class, Take a beginner's coding class"
}
